...
Split by sex. Note that the length and weight units influence the a and b estimates. FishBase uses centimeters and grams. The function can correct for the units when asked (but `length.unit` and `weight.unit` parameters have to be defined correctly)
